...
dependencies {
    ...
    // Please put the latest version of sakura here
    modImplementation(files("libs/Sakura.jar"))
...
loom {
    accessWidenerPath.assign(file("src/main/resources/addon.accesswidener"))
}
